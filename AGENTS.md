...
- **together-audio**: Text-to-speech (TTS) and speech-to-text (STT) via Together AI. TTS covers Orpheus, Kokoro, Cartesia, and dedicated-endpoint voice models across REST, streaming, and WebSocket APIs. STT covers Whisper, Voxtral, Parakeet, and dedicated-endpoint Deepgram models for transcription, translation, diarization, and realtime WebSocket transcription.
