...
| **together-sandbox** | Isolated gVisor sandboxes for RL training, SFT data generation, and coding agent rollouts on Together AI. | `parallel_fanout.py`, `sandbox_lifecycle.py` |
<!-- END_SKILLS_TABLE -->
